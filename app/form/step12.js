        ...
        <>
          ...
          >
            <Text
              style={[
                styles.radioText,
                selectedOption === 'Bombeiro' && styles.radioSelectedText,
              ]}
            >
              Bombeiro
            </Text>
          ...
          >
            <Text
              style={[
                styles.radioText,
                selectedOption === 'Empresa' && styles.radioSelectedText,
              ]}
            >
              Empresa
            </Text>
          ...
          <View style={styles.inputContainer}>
            ...
            <Dropdown
              ...
              data={tiposExtintores?.map((val) => ({ label: val, value: val })) || []}
              labelField="label"
              valueField="value"
              value={formData.tipoExtintor || tiposExtintores[0]}
              onChange={(item) => setFormData({ ...formData, tipoExtintor: item })}
              maxHeight={190}
            />
          </View>
        </>
